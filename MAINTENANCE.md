...
El criterio fundamental es: **se acepta software que da soporte específico a Andalucía, no software hecho por alguien de Andalucía.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Andalucía. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Andalucía no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Andalucía o una integración con servicios públicos de Andalucía sí.

- **Sí:** Clientes de APIs de instituciones de Andalucía, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Andalucía.
- **No:** Librerías genéricas creadas por equipos de Andalucía, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Andalucía** (no simplemente que el autor es de Andalucía).
2. Verificar que la PR incluye la **URL del servicio o institución de Andalucía** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-andalucia`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Andalucía |
