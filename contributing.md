# Contribuir a Awesome Andalucía
...
- El proyecto debe **dar soporte específico a Andalucía** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución andaluza** a la que el software da soporte (p.ej. juntadeandalucia.es, us.es, ugr.es). Esto ayuda a verificar que el proyecto es relevante para Andalucía.
